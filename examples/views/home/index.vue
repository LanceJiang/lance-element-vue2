...
<!--      <el-button plain disabled> addddddddd </el-button>
    ...
    <div class="content">
      {{testNumber}}
      <LeInputNumber disabled v-model="testNumber" :min="0" prefix="#" _controlsPosition="1"></LeInputNumber>
      <LeInputNumber v-model="testNumber" :min="0" prefix="#" suffix="￥" size="mini" _controlsPosition="1"></LeInputNumber>
      <LeInputNumber v-model="testNumber" :min="0" prefix="#" size="small" _controlsPosition="1"></LeInputNumber>
      <LeInputNumber v-model="testNumber" :min="0" suffix="￥" _controlsPosition="1"></LeInputNumber>
      <LeInputNumber size="mini" v-model="testNumber" :min="0" prefix="#" suffix="￥" _controlsPosition="1"></LeInputNumber>
      <LeInputNumber v-model="testNumber" :min="0" style="width: 300px;" controlsPosition="1">
...
<!--      <LeIcon iconClass="le-checkbox"></LeIcon>-->
<!--      <span class="le-iconfont le-radio_checked_disable"></span>-->
