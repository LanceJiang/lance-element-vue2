...
<script>
// import PdfPreview from 'adber-ui-demo/packages/PdfPreview'
import { PdfPreview, BarCode } from 'adber-ui-demo/packages/extra_load'
// import test from 'adber-ui-demo/packages/extra_load'
// console.error(test)
export default {
  name: 'others',
  components: {
