...
// import admin-ui locale 公用国际化 引入
// 本地 模拟多语言 测试
// // 此处使用方式是 结合 按需加载 提取locale 进行修改 i18n转译 当前组件没有做 语言方法提取
// import AdbLocale from '@lancegroup/admin-ui/src/locale' // 多语言 问题  lib  AdbLocale.i18n(fn) 修改完之后 未改变
import EnAdbLocale from '@lancegroup/admin-ui/src/locale/lang/en'
import CNAdbLocale from '@lancegroup/admin-ui/src/locale/lang/zh-cn'

// vxe-table 多语言注入
import EnVxeLocale from 'vxe-table/lib/locale/lang/en-US'
import CNVxeLocale from 'vxe-table/lib/locale/lang/zh-CN'
// 正式环境使用
/* // import AdbLocale from '@lancegroup/admin-ui/lib/locale' // 多语言 问题  lib  AdbLocale.i18n(fn) 修改完之后 未改变
import EnAdbLocale from '@lancegroup/admin-ui/lib/locale/lang/en'
import CNAdbLocale from '@lancegroup/admin-ui/lib/locale/lang/zh-cn' */
import Vue from 'vue'
...
// 为了 让 AdminUI 和 ElementUI 写法尽量相同 做统一调整
