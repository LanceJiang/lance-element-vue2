...
import { AdminUIComponent } from './component'

export type columnProps = {
  slots?: {
    default?: ((h, scope) => any) | string
    header?: ((h, scope) => any) | string
  }
...
/* Table */
export type TableProps = InstanceType<typeof ElTable>['$props'] & Options
...
/** Table Component */
export declare class AdTable extends AdminUIComponent {
/*  /!** Table data *!/
  data: object[]
